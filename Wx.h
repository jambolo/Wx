/** @file *//********************************************************************************************************
	...
	$Header: //depot/Libraries/Wx/Wx.h#14 $
...
class DeviceContext : public boost::noncopyable
{
public:
...
#define assert_succeeded( hr )	(void)( SUCCEEDED( hr ) || ( non_standard_assert_display( #hr " indicates failure.", __FILE__, __LINE__ ), 0 ) )
